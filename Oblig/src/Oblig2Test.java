...
public class Oblig2Test {
    public static void main(String[] args) {
        ...
        if (antallFeil == 0) {
            ...
            System.out.println
                    ("\nDette mÃ¥ forbedres. Du har minst "
    ...
    public static int oppgave1() {
        ...
        if (liste.antall() != 0) {
            antallFeil++;
            System.out.println("Oppgave 1e: Feil i konstruktÃ¸ren!");
        }

        if (liste.tom() != true) {
            antallFeil++;
            System.out.println("Oppgave 1f: Feil i konstruktÃ¸ren!");
        }
        ...
        if (liste.antall() != 1) {
            antallFeil++;
            System.out.println("Oppgave 1g: Feil i konstruktÃ¸ren!");
        }

        if (liste.tom() != false) {
            antallFeil++;
            System.out.println("Oppgave 1h: Feil i konstruktÃ¸ren!");
        }
        ...
        if (liste.antall() != 2) {
            antallFeil++;
            System.out.println("Oppgave 1i: Feil i konstruktÃ¸ren!");
        }
        ...
        if (liste.antall() != 3) {
            antallFeil++;
            System.out.println("Oppgave 1j: Feil i konstruktÃ¸ren!");
        }
        ...
        if (!Arrays.equals(a, b)) {
            antallFeil++;
            System.out.println("Oppgave 1k: KonstruktÃ¸ren endrer parametertabellen!");
        }
        ...
        if (liste.antall() != 0) {
            antallFeil++;
            System.out.println("Oppgave 1l: Feil i konstruktÃ¸ren!");
        }
        ...
        if (liste.antall() != 0) {
            antallFeil++;
            System.out.println("Oppgave 1m: Feil i konstruktÃ¸ren!");
        }
        ...
        if (liste.antall() != 0) {
            antallFeil++;
            System.out.println("Oppgave 1n: Feil i konstruktÃ¸ren!");
        }
        ...
        if (liste.antall() != 1) {
            antallFeil++;
            System.out.println("Oppgave 1o: Feil i konstruktÃ¸ren!");
        }
        ...
        if (liste.antall() != 3) {
            antallFeil++;
            System.out.println("Oppgave 1p: Feil i konstruktÃ¸ren!");
        }
        ...
        if (testliste.antall() > 5) {
            antallFeil++;
            System.out.println("Oppgave 1q: leggInn-metoden brukes i konstruktÃ¸ren!");
        }
    ...
    public static int oppgave2() {
        ...
        if (!s.equals("[1]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 2g: Du har " + s + ", skal vÃ¦re [1]!");
        }
        ...
        if (!s.equals("[1]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 2h: Du har " + s + ", skal vÃ¦re [1]!");
        }
        ...
        if (!s.equals("[1, 2]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 2i: Du har " + s + ", skal vÃ¦re [1, 2]!");
        }
        ...
        if (!s.equals("[2, 1]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 2j: Du har " + s + ", skal vÃ¦re [2, 1]!");
        }
        ...
        if (!s.equals("[1, 2, 3, 4]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 2k: Du har " + s + ", skal vÃ¦re [1, 2, 3, 4]!");
        }
        ...
        if (!s.equals("[4, 3, 2, 1]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 2l: Du har " + s + ", skal vÃ¦re [4, 3, 2, 1]!");
        }
        ...
        if (!t1.equals(t2)) {
            antallFeil++;
            System.out.println
                    ("Oppgave 2m: Du har " + t2 + ", men det skal vÃ¦re " + t1);
        }
    ...
    public static int oppgave3() {
        ...
        if (liste.antall() != 4) {
            antallFeil++;
            System.out.println
                    ("Oppgave 3o: antallEndringer skal Ã¸kes, men antall skal ikke endres!");
        }
        ...
        if (!s.equals("[-1, 2, 3, 5]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 3s: Du har " + s + ", skal vÃ¦re [-1, 2, 3, 5]!");
        }
        ...
        if (!s.equals("[5, 3, 2, -1]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 3t: Du har " + s + ", skal vÃ¦re [5, 3, 2, -1]!");
        }
        ...
        if (!iliste.subliste(0, 0).toString().equals("[]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 3u: Sublisten til en tom liste skal vÃ¦re tom!");
        }
        ...
        if (!cliste.subliste(0, 1).toString().equals("[A]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 3v: Sublisten skal inneholde kun fÃ¸rste verdi i listen!");
        }
        ...
        if (!cliste.subliste(0, 2).toString().equals("[A, B]")) {
            antallFeil++;
            System.out.println
                    ("Oppgave 3x: Sublisten skal inneholde kun de to fÃ¸rste verdiene!");
        }
        ...
        try {
            ...
            antallFeil++;
            System.out.println
                    ("Oppgave 3Ã¦: Det skal kastes et unntak nÃ¥r til er stÃ¸rre enn antall!");
        } catch (Exception e) {
            if (!e.getClass().getName().equals("java.lang.IndexOutOfBoundsException")) {
                antallFeil++;
                System.out.println
                        ("Oppgave 3Ã¸: Skal ha IndexOutOfBoundsException her!");
            }

            if (e.toString().contains("tablengde")) {
                antallFeil++;
                System.out.println
                        ("Oppgave 3Ã¥: Bruk ikke tablengde i feilmeldingen! Bruk antall!");
            }
        }
        ...
        try {
            ...
            antallFeil++;
            System.out.println
                    ("Oppgave 3Ã¥1: Det skal kastes et unntak nÃ¥r fra er negativ!");
        } catch (Exception e) {
            if (!e.getClass().getName().equals("java.lang.IndexOutOfBoundsException")) {
                System.out.println
                        ("Oppgave 3Ã¥2: Skal ha IndexOutOfBoundsException her!");
                antallFeil++;
            }
        }
        ...
        try {
            ...
            antallFeil++;
            System.out.println
                    ("Oppgave 3Ã¥3: Det skal kastes et unntak nÃ¥r fra er negativ!");
        } catch (Exception e) {
            if (!e.getClass().getName().equals("java.lang.IllegalArgumentException")) {
                System.out.println
                        ("Oppgave 3Ã¥4: Skal ha IllegalArgumentException her!");
                antallFeil++;
            }
        }
    ...
    public static int oppgave4() {
        ...
        if (sliste.indeksTil("Kari") != 0) {
            antallFeil++;
            System.out.println
                    ("Oppgave 4i: Skal gi indeks til fÃ¸rste forekomst hvis like verdier!");
        }
    ...
    public static int oppgave5() {
        ...
        try {
            ...
            antallFeil++;
            System.out.println(
                    "Oppgave 5a: Kan ikke legge inn pÃ¥ indeks -1!");
        } catch (Exception e) {
            if (!(e instanceof IndexOutOfBoundsException)) {
                System.out.println
        ...
        try {
            liste.leggInn(1, 1);
            antallFeil++;
            System.out.println("Oppgave 5c: Kan ikke legge inn pÃ¥ indeks 1 i en tom liste!");
        } catch (Exception e) {
            if (!(e instanceof IndexOutOfBoundsException)) {
        ...
        try {
            ...
            antallFeil++;
            System.out.println("Oppgave 5e: Ikke tillatt Ã¥ legge inn null-verdier!");
        } catch (Exception e) {
            if (!(e instanceof NullPointerException)) {
                System.out.println
    ...
    public static int oppgave6() {
        ...
        if (!liste.toString().equals("[C, E, F, H, I, B]")) {
            antallFeil++;
            System.out.println("Oppgave 6kc: Skal fjerne fÃ¸rste forekomst hvis flere like!");
        }
        ...
        if (liste.fjern(new String("A")) != true
            ...
            antallFeil++;
            System.out.println("Oppgave 6t: Stygg feil! Du MÃ… bruke equals");
        ...
        if (!liste.toString().equals("[]")) {
            System.out.println
                    ("Oppgave 6v: Her mÃ¥ det vÃ¦re en pekerfeil!");
            antallFeil++;
        }

        if (!liste.omvendtString().equals("[]")) {
            System.out.println
                    ("Oppgave 6w: Her mÃ¥ det vÃ¦re en pekerfeil!");
            antallFeil++;
        }
        ...
        if (!liste.toString().equals("[]")) {
            System.out.println
                    ("Oppgave 6y: Her mÃ¥ det vÃ¦re en pekerfeil!");
            antallFeil++;
        }

        if (!liste.omvendtString().equals("[]")) {
            System.out.println
                    ("Oppgave 6z: Her mÃ¥ det vÃ¦re en pekerfeil!");
            antallFeil++;
        }
        ...
        if (!liste.toString().equals("[A]")) {
            System.out.println
                    ("Oppgave 6zb: Her mÃ¥ det vÃ¦re en pekerfeil!");
            antallFeil++;
        }

        if (!liste.omvendtString().equals("[A]")) {
            System.out.println
                    ("Oppgave 6zc: Her mÃ¥ det vÃ¦re en pekerfeil!");
            antallFeil++;
        }
        ...
        if (!liste.toString().equals("[A]")) {
            System.out.println
                    ("Oppgave 6ze: Her mÃ¥ det vÃ¦re en pekerfeil!");
            antallFeil++;
        }

        if (!liste.omvendtString().equals("[A]")) {
            System.out.println
                    ("Oppgave 6zf: Her mÃ¥ det vÃ¦re en pekerfeil!");
            antallFeil++;
        }
        ...
        if (maks > 1.5 * min) {
            ...
            System.out.println("ved hjelp av den andre? Eller sÃ¥ er en av fjern-metodene dine litt treg.");
            antallFeil++;
        }
        return antallFeil;
    }
...
/*
    ...
    public static int oppgave9() {
        ...
        if (!liste.toString().equals("[]")) {
            antallFeil++;
            System.out.println("Oppgave 9d: Feil nÃ¥r remove() har slettet alle!");
        }
